 ...
 */
public class ScreeWXFragment extends BaseListFragment<Order> implements
        OnTabReselectListener {

    private static final String CACHE_KEY_PREFIX = "wxlist_";
    ...
    protected void sendRequestData() {
        LvTuShiGuangApi.getOrderList(user.getId(), "0", mCurrentPage + 1, mHandler);
    }
