...
import net.lvtushiguang.trip.bean.LoginUserBean;
import net.lvtushiguang.trip.bean.OpenIdCatalog;
...
public class LoginBindActivityChooseActivity extends BaseActivity {
    ...
    private void to_reg() {
        ...
        LvTuShiGuangApi.openid_reg(catalog, openIdInfo, new AsyncHttpResponseHandler() {
            @Override
