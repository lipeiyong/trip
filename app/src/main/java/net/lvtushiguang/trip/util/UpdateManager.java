...
import net.lvtushiguang.trip.bean.Update;
...
public class UpdateManager {
    ...
    public void checkUpdate() {
        ...
        LvTuShiGuangApi.checkUpdate(mCheckUpdateHandle);
    }
    ...
    private void showUpdateInfo() {
        ...
        AlertDialog.Builder dialog = DialogHelp.getConfirmDialog(mContext, mUpdate.getUpdate().getAndroid().getUpdateLog(),
