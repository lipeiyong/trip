...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String LTSG_DATABASE_NAME = "lvtushiguang";

    public static final String NOTE_TABLE_NAME = "ltsg_Notebook";
    ...
    public static final String NEWS_LIST = "ltsg_news_list";
    ...
    public DatabaseHelper(Context context) {
        super(context, LTSG_DATABASE_NAME, null, 1);
    }
