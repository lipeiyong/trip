...
import net.lvtushiguang.trip.widget.MyLinkMovementMethod;
import net.lvtushiguang.trip.widget.MyURLSpan;
import net.lvtushiguang.trip.widget.TweetTextView;
